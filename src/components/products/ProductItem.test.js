...
describe('product item', () => {
    it('renders title, description and price', () => {
        ...
        expect(screen.getByRole('heading', { level: 5 })).toHaveTextContent('Product 1');
        expect(screen.getByRole('heading', { level: 4 })).toHaveTextContent(/10/);
        expect(screen.getByText('Topping danish pudding halvah soufflé marshmallow sweet.')).toBeInTheDocument();
    })
